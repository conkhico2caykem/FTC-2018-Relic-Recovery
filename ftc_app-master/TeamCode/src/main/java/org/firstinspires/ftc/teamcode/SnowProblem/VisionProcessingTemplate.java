 ...
 */
@Autonomous(name="VisionTemp", group="Vision")
public class VisionProcessingTemplate extends LinearVisionOpMode {
        ...
        while (opModeIsActive()) {
            ...
            if(frameCount >=30){ //This gives OpenCV 30 frames to run the program before it switches over to vuforia
                 ...
                 * translational components */
                        ...
                        if(jewelOrientation.equals("red, blue")) {
                            telemetry.addData("red is left", "left");

                        }else if(jewelOrientation.equals("blue, red")) {
                            telemetry.addData("red is right", "right");
                        } else {
                            telemetry.addData("unknown", jewelOrientation);
                        }
                        switch (vuMark) {
                            case LEFT:
                                telemetry.addData("we are left", "LEFT");
                                break;
                            case CENTER:
                                telemetry.addData("we are Center", "Center");
                                break;
                            case RIGHT:
                                telemetry.addData("we are Right", "Right");
                                break;
